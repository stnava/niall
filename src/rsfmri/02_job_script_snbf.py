...
mysncalone = ants.threshold_image( mysnc, 7, 7 ) + ants.threshold_image( mysnc, 23, 23 )
...
# get BF labels
concattx =[]
concattx.append( t1reg['fwdtransforms'][0] ) #+ t1wtx + t1atx
concattx.append( t1reg['fwdtransforms'][1] ) #+ t1wtx + t1atx
