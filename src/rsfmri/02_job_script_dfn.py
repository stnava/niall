...
t1fns = glob.glob( rootdir + "*/*/T1wHierarchical/*/*"+targetsplit[ptidIndex]+"*" + targetsplit[dateIndex] + "*T1*brain_n4_dnz.nii.gz" )
t1sfns = glob.glob( rootdir + "*/*/T1wHierarchical/*/*"+targetsplit[ptidIndex]+"*" + targetsplit[dateIndex] + "*T1*tissue_segmentation.nii.gz" )
if len( t1fns ) == 0:
    t1fns = glob.glob( rootdir + "*/*/*/T1wHierarchical/*/*"+targetsplit[ptidIndex]+"*" + targetsplit[dateIndex] + "*T1*brain_n4_dnz.nii.gz" )
    t1sfns = glob.glob( rootdir + "*/*/*/T1wHierarchical/*/*"+targetsplit[ptidIndex]+"*" + targetsplit[dateIndex] + "*T1*tissue_segmentation.nii.gz" )
